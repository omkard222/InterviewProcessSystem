...
class RequirementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create requirement" do
    assert_difference('Requirement.count') do
      post requirements_url, params: { requirement: { experience: @requirement.experience, position: @requirement.position, qualification: @requirement.qualification, salary: @requirement.salary, skills: @requirement.skills } }
    end
  ...
  test "should update requirement" do
    patch requirement_url(@requirement), params: { requirement: { experience: @requirement.experience, position: @requirement.position, qualification: @requirement.qualification, salary: @requirement.salary, skills: @requirement.skills } }
